...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(cameraCanMove)
        {
            ...
            shootCamera.transform.localEulerAngles = new Vector3(pitch, 0, 0);
        }
...
// Custom Editor
    ...
    public class FirstPersonControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            fpc.shootCamera = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Shoot Camera", "Camera attached to the player shoot shoot."), fpc.shootCamera, typeof(GameObject), true);
